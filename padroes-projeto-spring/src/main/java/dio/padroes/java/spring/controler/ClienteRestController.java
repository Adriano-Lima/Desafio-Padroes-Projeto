package dio.padroes.java.spring.controler;
...
public class ClienteRestController {
    ...
    public ResponseEntity<Iterable<Cliente>> buscarTodosCep(@PathVariable String cep) {
        return ResponseEntity.ok(clienteService.buscarTodosCep(cep));
    }
